...
router.route('/users/:id_user/address').post(c.address.addAddress);
...
router.route('/users/:id_user/shopping_cart/order').post(c.orders.addOrderFromSC);
...
router.route('/users/:id_user/orders').post(c.orders.addOrder);
...
router.route('/business/:id_business/address').post(c.address.addAddress);
...
router.route('/test/:id_user').get(c.accessories.test);
